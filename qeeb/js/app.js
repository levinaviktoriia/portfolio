(() => {
    ...
    function initSliders() {
        if (document.querySelector(".popular-categories")) new swiper_core_Swiper(".popular-categories__slider", {
            ...
            loop: true,
            pagination: {
                el: ".popular-categories__swiper-pagination",
                clickable: true
            },
            navigation: {
        ...
        if (document.querySelector(".tranding")) new swiper_core_Swiper(".tranding__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            spaceBetween: 29,
            ...
            navigation: {
                prevEl: ".tranding__swiper-button-prev",
                nextEl: ".tranding__swiper-button-next"
            },
            breakpoints: {
                319: {
                    slidesPerView: 1,
